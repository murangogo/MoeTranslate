<template>
    <div class="download-section">
      ...
      <div class="download-buttons">
        <button @click="handleDownload(0, 'https://1812258729.share.123pan.cn/123pan/2f38Vv-aRi5H')" class="download-button pan-button">
        ...
        <button @click="handleDownload(2, 'https://repo.azuki.top/MoeTranslate_arm64-v8a_5.5.0.apk')" class="download-button local-button">
          <div class="button-content">
