...
config:
 -
   ...
   hero:
     ...
     text: This time, you are the protagonist.
     actions:
       -
         theme: brand
         text: Docs
 ...
 -
   ...
   features:
     -
       title: Screenshot-based Translation
       icon: 📲
       details: Universal and unrestricted
     -
       title: Multiple Translation Modes
       icon: ✨
       details: Support local OCR translation or direct image upload translation
     -
       title: Ready to Use
       icon: 🚀
       details: Zero configuration required, ready to use out of the box
     -
